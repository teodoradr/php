...
if(isset($_POST['email']) && !empty($_POST['email'])){
    echo $sql = "SELECT id, prenume, nume , email,zinastere, sex, telefon
    ...
    $sql = "SELECT id, prenume, nume , email,zinastere, sex, telefon FROM utilizatori";
    $result = mysqli_query($con, $sql);
    ...
    <?php
        while($row = mysqli_fetch_assoc($result)):?>
            <tr>
                ...
                <td><?php echo htmlentities($row["zinastere"]);?></td>
